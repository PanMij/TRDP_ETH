...
#define REAL_QUEUE_SIZE (200)                  //!< The real size of the queue.
#define QUEUE_SIZE (REAL_QUEUE_SIZE + 1)       //!< A redundance space is needed to distinguish empty queue and full queue.
#define PAKET_LENGTH (1728)                    //!< If this value is modified, the same value in tcp_transmission.h must be modified as well.
