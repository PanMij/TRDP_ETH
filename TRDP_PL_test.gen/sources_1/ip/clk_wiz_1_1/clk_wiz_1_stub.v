...
module clk_wiz_1(clk_25m_90d, reset, locked, clk_in1)
/* synthesis syn_black_box black_box_pad_pin="clk_25m_90d,reset,locked,clk_in1" */;
  output clk_25m_90d;
  input reset;
  output locked;
  input clk_in1;
