...
set_case_analysis 0 [get_pins -of [get_cells -hier -filter { name =~ *i_bufgmux_gmii_90_clk } ] -filter {REF_PIN_NAME == CE0}]
set_case_analysis 0 [get_pins -of [get_cells -hier -filter { name =~ *i_bufgmux_gmii_90_clk } ] -filter {REF_PIN_NAME == S0}]
set_case_analysis 1 [get_pins -of [get_cells -hier -filter { name =~ *i_bufgmux_gmii_90_clk } ] -filter {REF_PIN_NAME == CE1}]
set_case_analysis 1 [get_pins -of [get_cells -hier -filter { name =~ *i_bufgmux_gmii_90_clk } ] -filter {REF_PIN_NAME == S1}]
