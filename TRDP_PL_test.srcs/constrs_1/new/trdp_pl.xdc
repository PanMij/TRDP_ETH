...
# set_property PACKAGE_PIN AB17 [get_ports eth_mdc]
# set_property PACKAGE_PIN Y14 [get_ports eth_mdio]
# set_property PACKAGE_PIN AA17 [get_ports eth_rst_n]
# set_property PACKAGE_PIN AA4 [get_ports {eth_rxd[0]}]
# set_property PACKAGE_PIN Y4 [get_ports {eth_rxd[1]}]
# set_property PACKAGE_PIN AB4 [get_ports {eth_rxd[2]}]
# set_property PACKAGE_PIN AB5 [get_ports {eth_rxd[3]}]
# set_property PACKAGE_PIN AB9 [get_ports {eth_txd[0]}]
# set_property PACKAGE_PIN AB10 [get_ports {eth_txd[1]}]
# set_property PACKAGE_PIN AA8 [get_ports {eth_txd[2]}]
# set_property PACKAGE_PIN AA9 [get_ports {eth_txd[3]}]
# set_property PACKAGE_PIN AB2 [get_ports eth_rx_ctl]
# set_property PACKAGE_PIN Y6 [get_ports eth_rxc]
# set_property PACKAGE_PIN AA7 [get_ports eth_tx_ctl]
# set_property PACKAGE_PIN AA6 [get_ports eth_txc]
# set_property PACKAGE_PIN B19 [get_ports RGMII_1_rxc]
# set_property PACKAGE_PIN C15 [get_ports MDIO_PHY_1_mdc]
# set_property PACKAGE_PIN B15 [get_ports MDIO_PHY_1_mdio_io]
# set_property PACKAGE_PIN E21 [get_ports {RGMII_1_rd[3]}]
# set_property PACKAGE_PIN D21 [get_ports {RGMII_1_rd[2]}]
# set_property PACKAGE_PIN D22 [get_ports {RGMII_1_rd[1]}]
# set_property PACKAGE_PIN C22 [get_ports {RGMII_1_rd[0]}]
# set_property PACKAGE_PIN B16 [get_ports {RGMII_1_td[3]}]
# set_property PACKAGE_PIN B17 [get_ports {RGMII_1_td[2]}]
# set_property PACKAGE_PIN A16 [get_ports {RGMII_1_td[1]}]
# set_property PACKAGE_PIN A17 [get_ports {RGMII_1_td[0]}]
# set_property PACKAGE_PIN B21 [get_ports RGMII_1_rx_ctl]
# set_property PACKAGE_PIN A18 [get_ports RGMII_1_tx_ctl]
# set_property PACKAGE_PIN A19 [get_ports RGMII_1_txc]
